                            ...
                            {item.candidatos.map((candidato) => (
                                ...
                                >
                                    ...
                                    <div className='body text-center p-5'>
                                        <h3 className='text-3xl font-bold mb-1 text-slate-800'>{candidato.nombre}</h3>
                                        <p className='text-xl font-normal text-slate-500'>{candidato.partido}</p>
                                        <button  
                                        className='btn mt-7 mb-3 '
